<script setup>
    ...
    const getChartData = async ()=>{
        ...
        const oneEchart = echarts.init(proxy.$refs['orderEchart'])
    ...
    <el-row class="home" :gutter="20">
        <el-col :span="8" style="margin-top: 20px">
            <el-card shadow="hover">
                <div class="user">
                    ...
                    <div class="user-info">
                        <p class="user-info-admin">Lion</p>
                        <p class="user-info-p">超级管理员</p>
                    </div>
                </div>
                <div class="login-info">
                    <p>上次登录时间：<span>2025年7月13日18:52:57</span></p>
                    <p>上次登录地点：<span>地点</span></p>
                </div>
            </el-card>
        ...
        <el-col :span="16" style="margin-top: 20px">
            <div class="num">
                ...
                <el-card class="top-echart" style="width: 100%">
